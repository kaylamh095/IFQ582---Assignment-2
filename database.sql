...
CREATE TABLE `access_request` (
  ...
  CONSTRAINT `access_request_ibfk_2` FOREIGN KEY (`member_ID`) REFERENCES `library_member` (`member_ID`)
...
INSERT INTO `community_elder` VALUES (1,'Turrbal People',5),(2,'Ningy Ningy People',6);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `config` (
  `media_uri` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `library_member` VALUES (1,3),(2,4);
...
INSERT INTO `library_staff` VALUES (1,'Library Director','2026-02-02',1),(2,'Librarian','2026-04-13',2);
...
-- Dump completed on 2026-06-17  9:47:45
