...
from ..models.item import CollItem
...
def item():
    ...
    return render_template('item.html', items=itemsall) ### pass the data to the item template to display # items= needs to match the jinja x in items statement in item.html
